...
key_codes: Dict[int, KeyInfo] = {
    0x04: KeyInfo('a', 'a', (Matrix.row2, Matrix.col1)),
    ...
    0x09: KeyInfo('f', 'f', (Matrix.row5, Matrix.col2)),
    0x0a: KeyInfo('g', 'g', (Matrix.row2, Matrix.col3)),
    0x0b: KeyInfo('h', 'h', (Matrix.row5, Matrix.col3)),
    0x0c: KeyInfo('i', 'i', (Matrix.row1, Matrix.col4)),
    0x0d: KeyInfo('j', 'j', (Matrix.row2, Matrix.col4)),
    0x0e: KeyInfo('k', 'k', (Matrix.row5, Matrix.col4)),
    ...
    0x54: KeyInfo('KP_SLASH', 'KP_/',      (Matrix.row7, Matrix.col6)),
    0x55: KeyInfo('KP_STAR',  'KP_*',      (Matrix.row1, Matrix.col6)),
    0x56: KeyInfo('KP_MINUS', 'KP_-',      (Matrix.row2, Matrix.k1)),
    0x57: KeyInfo('KP_PLUS',  'KP_+',      (Matrix.row1, Matrix.k1)),
    0x58: KeyInfo('KP_ENTER', 'KP_ENTER', (Matrix.row4, Matrix.k1)),
    0x59: KeyInfo('KP_1',     'KP_1',     (Matrix.row7, Matrix.k0)),
    0x5a: KeyInfo('KP_2',     'KP_2',     (Matrix.row4, Matrix.k0)),
    0x5b: KeyInfo('KP_3',     'KP_3',     (Matrix.row7, Matrix.k1)),
    0x5c: KeyInfo('KP_4',     'KP_4',     (Matrix.row5, Matrix.k0)),
    0x5d: KeyInfo('KP_5',     'KP_5',     (Matrix.row2, Matrix.k0)),
    0x5e: KeyInfo('KP_6',     'KP_6',     (Matrix.row5, Matrix.k1)),
    0x5f: KeyInfo('KP_7',     'KP_7',     (Matrix.row6, Matrix.k0)),
    0x60: KeyInfo('KP_8',     'KP_8',     (Matrix.row1, Matrix.k0)),
    0x61: KeyInfo('KP_9',     'KP_9',     (Matrix.row6, Matrix.k1)),
    0x62: KeyInfo('KP_0',     'KP_0',     (Matrix.row1, Matrix.k2)),
    ...
    0x6b: KeyInfo('RCTRL', 'CTRL',    (Matrix.row2, Matrix.col7)),
