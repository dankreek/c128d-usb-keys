...
def main(args: List[str]) -> int:
    ...
    # Generate usb_keys.hpp
    with open(path.join(this_dir, 'c128d_usb_keys.hpp.template')) as f:
        usb_keys_template = Template(f.read())
    ...
    with open(path.join(this_dir, '..', 'lib', 'C128D-USB-Keys', 'c128d_usb_keys.hpp'), 'w') as f:
    ...
    with open(path.join(this_dir, '..', 'lib', 'C128D-USB-Keys', 'key_mapping.cpp'), 'w') as f:
